...
<template>
  <div
    class="customer-news-rail overflow-hidden rounded-md border border-grey-50 bg-background-on-canvas p-1.5"
    role="region"
  ...
  >
    <div class="customer-news-rail-track flex w-max items-center gap-1 will-change-transform">
      ...
      >
        <span class="whitespace-nowrap text-xs font-medium text-negative-500">
          {{ message }}
        </span>
        <span
