...
import {
  ...
  TRACK_ORDER_STATUS_OPTIONS,
  type TrackOrderListFilters,
} from '~/lib/track-order-filters';
import type { OrderStatusFilter } from '~/lib/order-status';
...
const emit = defineEmits<{
  apply: [filters: Partial<TrackOrderListFilters>];
  clearAll: [];
}>();
...
const draftStatus = ref<OrderStatusFilter[]>([]);
