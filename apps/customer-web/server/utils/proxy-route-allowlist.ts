...
export const PROXY_ROUTE_RULES: ProxyRouteRule[] = [
  ...
  { methods: ["PATCH"], pattern: /^notification\/bulk-read$/ },
  { methods: ["PATCH"], pattern: /^notification\/bulk-unread$/ },
  { methods: ["PATCH"], pattern: /^notification\/[^/]+\/read$/ },
  { methods: ["PATCH"], pattern: /^notification\/[^/]+\/unread$/ },
  { methods: ["DELETE"], pattern: /^notification\/read$/ },
  { methods: ["DELETE"], pattern: /^notification\/bulk$/ },
