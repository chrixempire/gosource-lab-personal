        ...
        <DialogContent class="z-[100] max-w-lg">
          ...
          <DialogBody v-if="selected" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                <p class="text-xs font-medium uppercase tracking-wide text-grey-500">Category</p>
                <p class="mt-1 text-sm text-grey-800">{{ categoryLabel(selected.category) }}</p>
              </div>
              <div>
                <p class="text-xs font-medium uppercase tracking-wide text-grey-500">Status</p>
                <StatusTag :variant="statusVariant(selected.status)" size="medium" class="mt-1">
              ...
              <div v-if="selected.page" class="col-span-2">
                <p class="text-xs font-medium uppercase tracking-wide text-grey-500">Page</p>
                <p class="mt-1 break-words text-sm text-grey-800">{{ selected.page }}</p>
              </div>
            </div>
          </DialogBody>
        </DialogContent>
